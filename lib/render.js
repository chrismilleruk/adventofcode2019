 ...
 * @param {{x: Number, y: Number}} offset 
 */
function plotPanelAsBlock(cursor, panel, blocks, offset) {
...
module.exports = { renderAllPanels, calculateMinMax, preparePlotArea, plotPanels, isRoomToRender, waitForRoomToRender, YAXIS, Panel };
